...
public class AdventureGame {
    ...
    private enum Compass {
        ...
        public String getString() {
            ...
            // this.ordinal will return a number corresponding to direction string array (N -> 1, "North")
        }
    }
    ...
    private void loadLocations(String data) {
        for (String s : data.split("\\R")) {
            // \\R will split up text block by each line. More robust than \n.
            String[] parts = s.split(",", 3);
            Arrays.asList(parts).replaceAll(String::trim); // quick way to remove trailing and leading spaces in the array of strings.
